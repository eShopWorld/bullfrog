...
namespace Client
{
    ...
    public static partial class BullfrogApiExtensions
    {
            ...
            /// <param name='body'>
            /// </param>
            public static ScaleEvent SaveScaleEvent(this IBullfrogApi operations, string scaleGroup, System.Guid eventId, ScaleEvent body = default(ScaleEvent))
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<ScaleEvent> SaveScaleEventAsync(this IBullfrogApi operations, string scaleGroup, System.Guid eventId, ScaleEvent body = default(ScaleEvent), CancellationToken cancellationToken = default(CancellationToken))
            {
