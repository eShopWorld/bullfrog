...
namespace Client
{
    ...
    public partial interface IBullfrogApi : System.IDisposable
    {
        ...
        /// The cancellation token.
        /// </param>
        Task<HttpOperationResponse<FeatureFlagsConfiguration>> GetFeatureFlagsWithHttpMessagesAsync(Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// The cancellation token.
        /// </param>
        Task<HttpOperationResponse<FeatureFlagsConfiguration>> SetFeaturesWithHttpMessagesAsync(FeatureFlagsConfiguration body, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
